...
QUERY_REWRITER = os.getenv("QUERY_REWRITER", "openai")
QUERY_REWRITER_MODEL = os.getenv("QUERY_REWRITER_MODEL", QUERY_EXTRACTOR_MODEL)
...
QDRANT_SOURCE_URL = os.getenv("QDRANT_SOURCE_URL", "http://127.0.0.1:6333")
