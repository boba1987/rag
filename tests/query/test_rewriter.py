...
def test_strips_filler_and_canonicalizes_provider() -> None:
    rewritten = rewrite_query("Can you tell me how much Ring Central costs?", extraction=PRICING)
...
def test_review_query_adds_reviews_term() -> None:
    rewritten = rewrite_query("What do customers say about Nextiva support?", extraction=REVIEW)
